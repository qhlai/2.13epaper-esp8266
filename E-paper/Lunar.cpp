...
unsigned int LunarCalendar(unsigned int year, unsigned int month, unsigned int day, unsigned int* LunarCalendarDay)
{
	unsigned int Spring_NY, Sun_NY, StaticDayCount;
...
String Lunar(int year,int month,int day)
{
	...
	//LunarCalendar(year, month, day, unsigned )
