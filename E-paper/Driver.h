...
GxEPD2_BW<GxEPD2_213, GxEPD2_213::HEIGHT> display(GxEPD2_213(/*CS=D4*/ SS, /*DC=D2*/ 4, /*RST=D0*/ 16, /*BUSY=D1*/ 5)); // GDE0213B1, phased out
...
//			delay(2000);
//		}
//		for (uint16_t i = 0; i < sizeof(bitmap_pairs) / si_GxBitmaps3c104x212_H_zeof(bitmap_pair); i++)
//		{
//			int16_t x = -60;
//			int16_t y = -60;
//			for (uint16_t j = 0; j < 10; j++)
